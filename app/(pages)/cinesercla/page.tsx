...
const page = () => {
  return (
    <Container>
      <div className="w-full flex flex-col gap-y-10 text-white">
        <h3>Our Projects</h3>
        ...
        <div className="w-full flex flex-col sm:flex-row gap-8 font-[family-name:var(--font-manrope)] text-xl">
          ...
          <div className="w-full sm:w-1/2 flex flex-col">
            ...
            <span className="text-base sm:text-lg">
              Cinesercla, established in 1980, is one of Brazil's top cinema
              groups, with nearly 80 theaters across 7 states. Since 1997, the
              brand has focused on Shopping Centers, forming strong partnerships
              with developers to grow its presence. Combining efficiency with
              modern appeal, Cinesercla remains committed to delivering a
              top-tier movie-going experience.
            </span>
          </div>
        </div>
