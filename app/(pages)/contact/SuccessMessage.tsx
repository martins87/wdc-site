...
const SuccessMessage = () => {
  return (
    <div className="w-full p-2 flex justify-start gap-x-2 md:gap-x-6 rounded-3xl bg-message_background/40 mb-4">
      ...
      <span className="w-[90%] flex items-center text-sm md:text-base tablet:text-xl font-[family-name:var(--font-manrope)] text-white">
